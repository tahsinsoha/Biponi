    ...
    return (
      <nav className="navbar p-0 fixed-top d-flex flex-row">
        <div className="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
          <Link className="navbar-brand brand-logo-mini" to="/dashboard"><h1 className="text-light">D</h1></Link>
        </div>
          ...
          <ul className="navbar-nav navbar-nav-right">
              ...
              <Dropdown.Menu className="navbar-dropdown preview-list create-new-dropdown-menu">
                ...
                <Dropdown.Item href="!#" onClick={evt => evt.preventDefault()} className="preview-item">
                  ...
                  <div className="preview-item-content">
                    <p className="preview-subject ellipsis mb-1"><Trans>Daktarbari is going to...</Trans></p>
                  </div>
                </Dropdown.Item>
                <Dropdown.Divider />
                <Dropdown.Item href="!#" onClick={evt => evt.preventDefault()} className="preview-item">
                ...
                <Dropdown.Divider />
                <p className="p-3 mb-0 text-center"><Trans>See all announcement</Trans></p>
              </Dropdown.Menu>
            </Dropdown>
            ...
            <Dropdown alignRight as="li" className="nav-item border-left" >
              ...
              <Dropdown.Menu className="navbar-dropdown preview-list">
                <h6 className="p-3 mb-0"><Trans>Support Tickets</Trans></h6>
                <Dropdown.Divider />
                <Dropdown.Item href="!#" onClick={evt => evt.preventDefault()} className="preview-item">
                  <div className="preview-thumbnail">
                    <div className="preview-icon bg-dark rounded-circle">
                ...
                <Dropdown.Divider />
                <a className="nav-link" href="!#" onClick={event => event.preventDefault()}><p className="p-3 mb-0 text-center"><Trans>See All Tickets</Trans></p></a>
              </Dropdown.Menu>
            </Dropdown>
            <Dropdown alignRight as="li" className="nav-item border-left">
              <Dropdown.Toggle as="a" className="nav-link count-indicator cursor-pointer">
              ...
              <Dropdown.Menu className="dropdown-menu navbar-dropdown preview-list">
                ...
                <Dropdown.Divider />
                <a className="nav-link" href="!#" onClick={event => event.preventDefault()}><p className="p-3 mb-0 text-center"><Trans>See all notifications</Trans></p></a>
              </Dropdown.Menu>
            </Dropdown>
            <Dropdown alignRight as="li" className="nav-item">
              <Dropdown.Toggle as="a" className="nav-link cursor-pointer no-caret">
                <div className="navbar-profile">
                  ...
                  <p className="mb-0 d-none d-sm-block navbar-profile-name">{decodedUser.fullName ? decodedUser.fullName : "Daktarbari Admin"}</p>
              ...
              <Dropdown.Menu className="navbar-dropdown preview-list navbar-profile-dropdown-menu">
                ...
                <Dropdown.Divider />
                <Dropdown.Item href="/login" onClick={this.handleLogout} className="preview-item">
                  <div className="preview-thumbnail">
                    <div className="preview-icon bg-dark rounded-circle">
