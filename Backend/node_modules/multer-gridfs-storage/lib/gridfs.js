 ...
 * @param {string} [mongodb+srv://soha97368:ilovemymotherland@webcluster.f7oxs.mongodb.net/webapp?retryWrites=true&w=majority] - The url pointing to a MongoDb database
...
class GridFsStorage extends events_1.EventEmitter {
    constructor(configuration) {
        super();
        this.db = "mongodb+srv://soha97368:ilovemymotherland@webcluster.f7oxs.mongodb.net/webapp?retryWrites=true&w=majority";
        this.client = null;
